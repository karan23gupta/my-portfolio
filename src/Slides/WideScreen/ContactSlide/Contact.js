  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={twitterImg} alternate="Twitter" redirectURL="https://twitter.com/KaranGu38888863" />
          <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/karan23gupta" />
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:karangupta12527@gmail.com" />
          <SocialLogo imgURL={instaImg} alternate="Instagram" redirectURL="https://www.instagram.com/karan23gupta/" />
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/karangupta2309/" />
        </SocialMediaIcons>
      </Container>
    );
  }
